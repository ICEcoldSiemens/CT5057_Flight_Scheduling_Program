# CT5057_Flight_Scheduling_Program
A flight scheduling program that enables customers to book and schedule flights, utilizing a variety of data structures.. Assigned to grasp the design and functionality of fundamental searching, sorting, and traversing algorithms.
...
- The number and range of economy class seats (i.e. 20 seats, seats 16 - 35) <br></br>


A particular class can have an arbitrary range of seats (i.e. first class, 5 seats, seats 1, 5, 9, 11, 21). Once the list of flights is given, you are ready to start scheduling passengers.
...
Flight information: print the information for a flight; Print the departure airport, the departure date, the arrival airport, and a list of all the seats and the name of the passenger in each seat.<br></br>
...
·       at least one of the searching algorithms studied during the lectures; <br></br>
